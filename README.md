...
This is the optional source installation channel. Prebuilt releases and the
personal Homebrew formula are described above. `lazypkg upgrade` updates a selected
